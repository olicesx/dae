...
// caller-owned PacketConn that quic-go will not close. setupTransport
// records createdConn=false for a supplied PacketConn, so CloseWithError
// alone would leak the underlying UDP socket.

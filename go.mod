...
require (
	...
	github.com/daeuniverse/outbound v0.0.0-sticky-ip.0.20260722030922-7722149db422
...
replace github.com/daeuniverse/outbound => github.com/olicesx/outbound v0.0.0-sticky-ip.0.20260722030922-7722149db422

...
require (
	...
	github.com/daeuniverse/outbound v0.0.0-sticky-ip.0.20260720102908-9bec799b3e24
...
replace github.com/daeuniverse/outbound => github.com/olicesx/outbound v0.0.0-sticky-ip.0.20260720102908-9bec799b3e24

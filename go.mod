...
require (
	...
	github.com/daeuniverse/outbound v0.0.0-sticky-ip.0.20260721102600-45244e4f35ec
...
replace github.com/daeuniverse/outbound => github.com/olicesx/outbound v0.0.0-sticky-ip.0.20260721102600-45244e4f35ec
